package br.com.doggallery.util.livedata
...
class LiveDataRetrofitCallAdapter<R>(private val responseType: Type) :
        ...
        return object : LiveData<GenericApiResponse<R>>() {
            ...
            override fun onActive() {
                ...
                if (started.compareAndSet(false, true)) {
                   ...
                   // postValue(GenericApiResponse.create(loading = true))
